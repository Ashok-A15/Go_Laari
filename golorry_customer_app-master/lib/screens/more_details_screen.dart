...
class _MoreDetailsScreenState extends State<MoreDetailsScreen> {
  final bool _detailsExpanded = true;
                  ...
                  child: Wrap(
                    ...
                    children: _goodsTypes.entries.map((e) {
                      ...
                      return GestureDetector(
                        onTap: () => setState(() {
                          if (sel) {
                            _selectedGoods.remove(e.key);
                          } else {
                            _selectedGoods.add(e.key);
                          }
                        }),
                ...
                _sectionCard(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'E.g. Handle with care, fragile items, ring doorbell…',
  ...
  Widget _paymentOption(String method, IconData icon, String sub, bool isDark) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: sel
              ? const Color(0xFF00915E).withValues(alpha: 0.06)
              : Colors.transparent,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: sel ? const Color(0xFF00915E) : AppColors.border,
            width: sel ? 1.5 : 0.5,
          ),
        ),
        child: Row(
          children: [
            Icon(
              icon,
              size: 20,
              color: sel ? const Color(0xFF00915E) : AppColors.textMuted,
            ),
            const SizedBox(width: 10),
            Expanded(
              child: Column(
